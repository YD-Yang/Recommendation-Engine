# -*- coding: utf-8 -*-
"""
https://github.com/yxtay/recommender-tensorflow/blob/master/trainers/deep_fm.py
"""
...
from conf_utils import get_run_config, get_train_spec, get_exporter, get_eval_spec
from feature_prep import get_feature_columns, get_input_fn, serving_input_fn
from model_utils import layer_summary, get_optimizer
...
def train_and_evaluate(args):
    ...
    parser.add_argument("--train-csv", default="df_train.csv",
                        help="path to the training csv data (default: %(default)s)")
    parser.add_argument("--test-csv", default="df_test.csv",
                        help="path to the test csv data (default: %(default)s)")
    parser.add_argument("--job-dir", default="output\model_v01",
